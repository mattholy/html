...
<body>
	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<nav>
				<ul>
					<li><a href="#print">云打印</a>
					</li>
					<li><a href="#table">文件下载</a>
					</li>
		...
		<div id="main">
			...
			<article id="print">
				...
				<p>为了保证打印效果，该系统仅可以打印<b> .pdf </b>格式的文件</br><i>Office系列格式，.doc、.docx等，并非跨设备格式，不同设备打开的效果可能不同。请导出为<b> .pdf </b>后进行打印操作！</i>
				</p>
				<section>
			...
			<article id="printpage1">
				...
				<ul class="actions">
					<li><a href="#print" class="button special icon fa-print">继续打印</a>
					</li>
					<li><a href="#" class="button">返回</a>
					</li>
				</ul>
			</article>
			...
			<article id="table">
				...
				<div class="field">
					<h3>种类</h3>
					<form action="filelist.php" method="post" target="filelistarea" id="filearea">
					<div class="select-wrapper">
						<select name="filecategory" id="filecategory" onChange="getfilelist()">
							<option value="">-</option>
				...
				<iframe name="filelistarea" id="filelistarea" src="" style="opacity:1;width:100%;height:0.5rem;"></iframe>
				<h3>内容</h3>
					<div class="table-wrapper" id="filelistcontent">
					</div>
			</article>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<section>
					...
					<ul class="actions">
						<li><a href="#" class="button special icon fa-download">Icon</a>
						</li>
						<li><a href="#" class="button icon fa-print">Icon</a>
						</li>
					</ul>
					<ul class="actions">
						<li><span class="button special disabled">Disabled</span>
						</li>
						<li><span class="button disabled">Disabled</span>
						</li>
					</ul>
				</section>
